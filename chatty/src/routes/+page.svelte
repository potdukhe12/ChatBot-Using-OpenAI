<script lang="ts">
	...
	import Logo from '../img/ayakshm-logo2.png'
...
<div class="row  pt-3">
	<div style="float: left;">
		<img src={Logo} style="height:80px;border-radius: 20px;" alt="logo" />	
	</div>
	<div style="float: left">
		<p style="color: #242F40">''''''''''</p>
	</div>
	<div style="float: left;">
		<h1 class="text-2xl font-bold w-full text-center">Sample Bot</h1>
		<p class="text-sm italic text-center">
			Powered by gpt-3.5-turbo<br/>
			-- Managed by <b>Saurabh Potdukhe</b>
		</p>
	</div>
</div>
